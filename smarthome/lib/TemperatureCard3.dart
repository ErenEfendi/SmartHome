...
class TemperatureCard3 extends StatefulWidget {
  const TemperatureCard3({super.key});

  @override
  State<StatefulWidget> createState() {
    return _TemperatureCard3State();
  }
}

class _TemperatureCard3State extends State<TemperatureCard3> {
  ...
  void _fetchTemperature() {
    _temperatureSubscription = _database
        .child("/SmartHome/monitoring/temperature3")
        .onValue
        .listen((event) {
