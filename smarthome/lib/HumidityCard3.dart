...
class HumidityCard3 extends StatefulWidget {
  const HumidityCard3({super.key});

  @override
  State<StatefulWidget> createState() {
    return _HumidityCard3State();
  }
}

class _HumidityCard3State extends State<HumidityCard3> {
  ...
  Future<void> _fetchHumidityLevel() async {
    _humiditySubscription = _database
        .child("/SmartHome/monitoring/humidityLevel3")
        .onValue
        .listen((event) {
